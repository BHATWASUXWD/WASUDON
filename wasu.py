...
╚███╔███╔╝██║  ██║███████║╚██████╔╝
 ╚══╝╚══╝ ╚═╝  ╚═╝╚══════╝ ╚═════╝                                      
╔════════════════════════════════════════════════════════════════╗
║\033[1;33m[=] OWNER                   :    WASU                 ║             
║\033[1;32m[=] 𝐆𝐈𝐓𝐇𝐔𝐁                  :   BHATWASUXWD                      ║         
║\033[1;36m[=] 𝐑𝐔𝐋𝐄𝐗                   : ACCESS PAGE TOKEN                 ║             
║\033[1;33m[=] 𝐅𝐀𝐂𝐄𝐁𝐎𝐊                 : ❮❮  WASU X 420  ❯❯                  ║           
╚════════════════════════════════════════════════════════════════╝
    """
    ...
    print(Fore.CYAN + "\033[1;91m\033[1;41m\033[1;33mTERMUX FREE COMMAND WORLD 2024  WASU INXID FB PAGE TOKEN ACCESS\033[;0m\033[1;91m\033[1;92m\033[38;5;46m")
    print(Fore.CYAN + "[-𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝐖𝐀𝐒𝐔  𝗧𝗢𝗢𝗟 𝐀𝐈𝐒𝐇 𝗞𝗥𝗢 𝗣𝗔𝗚𝗘 𝗜𝗗 𝗞𝗜 𝗧𝗢𝗞𝗘𝗡 𝗔𝗡𝗗 𝗚𝗥𝗢𝗨𝗣 𝗞𝗜 𝗨𝗜𝗗-]")
